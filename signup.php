...
<h1 style="text-align:center"><u>SIGNUP</u></h1>
    ...
    <span style="color:white; background-color:black"><?php echo $password_err; ?></span>
    ...
    <span style="color:white; background-color:black"><?php echo $con_pass_err;?></span>
